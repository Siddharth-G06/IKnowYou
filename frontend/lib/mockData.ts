...
export const mockPeople: Person[] = [
  ...
  },
  {
    ...
    relation: 'Colleague',
    tags: [
      { label: 'Colleague', category: 'colleague' },
      { label: 'Design', category: 'other' },
    ],
  ...
  },
  {
    ...
    relation: 'Friend',
    tags: [
      { label: 'Friend', category: 'friend' },
      { label: 'Badminton', category: 'other' },
    ],
